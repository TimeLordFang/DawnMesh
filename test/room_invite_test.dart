...
void main() {
  ...
  test(
    'real TCP protected rooms carry chat, history and audio; wrong invite cannot join',
    () async {
      final invite = RoomInvite.generate();
      final wire = <Frame>[];
      ...
      expect(
        Frame.decode(
          (lateGuest.audioIo as MockAudioIo).submittedFrames.single,
        )!.payload,
        [11, 22, 33],
      );
      final wrong = await make('Wrong', RoomInvite.generate());
