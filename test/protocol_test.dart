...
import 'package:dawn_mesh/core/protocol/payloads/ptt_state.dart';
import 'package:dawn_mesh/core/protocol/payloads/roster.dart';

void main() {
  group('DawnMesh Binary Protocol Tests', () {
    ...
    group('ChatMessagePayload Tests', () {
      test('Chat payload v2 roundtrip with timestamp and senderCode', () {
        const sample = '你好 DawnMesh 🌅 👨‍👩‍👧‍👦 测试消息 123!';
      ...
      test('Empty or whitespace text throws ArgumentError on encode', () {
        expect(
          () => const ChatMessagePayload(text: '').encode(),
          throwsArgumentError,
        );
        expect(
          () => const ChatMessagePayload(text: '   \n\t  ').encode(),
          throwsArgumentError,
        );
      });
