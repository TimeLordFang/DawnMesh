...
> 当前正式版本：`1.0.0`。安装包请从 [GitHub Releases](https://github.com/TimeLordFang/DawnMesh/releases) 获取。
...
打开 [GitHub Releases](https://github.com/TimeLordFang/DawnMesh/releases)，下载 `DawnMesh-1.0.0-release.apk`。每个 Release 同时提供 SHA-256 校验文件。
